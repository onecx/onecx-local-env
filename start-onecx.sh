...
echo -e "${CYAN}Start OneCX Local environment using profile '$profile'${NC}"

#docker compose -f versions/v2/docker-compose.v2.yaml --env-file versions/v2/.env --profile $profile up -d
