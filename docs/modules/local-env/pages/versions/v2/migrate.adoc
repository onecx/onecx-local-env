...
This guide highlights the key differences between OneCX Local Environment xref:../v1/v1.adoc[v1] and xref:./v2.adoc[v2], and explains how you can adapt your setup to ensure that it seamlessly works with xref:./v2.adoc[v2].

== Network Rename

In xref:../v1/v1.adoc[v1], the network that all services connected to was named `example`.  
