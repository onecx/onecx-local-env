...
An appropriate user is used to execute the import. The user is authorized, the token are getted and then the import is executed with the token as request header. Therefore the security option is enabled.
  * default (default)
  * t1
  * t2
