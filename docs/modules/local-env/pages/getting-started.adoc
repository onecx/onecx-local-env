...
- xref:local-env:versions/v1/v1.adoc[OneCX Local Environment v1]
...
- xref:local-env:versions/v2/v2.adoc#importing-initial-data[Importing initial data for OneCX Local Environment v2]
- xref:local-env:versions/v1/v1.adoc#importing-initial-data[Importing initial data for OneCX Local Environment v1]
...
- xref:local-env:versions/v2/v2.adoc#running-onecx-local-env-v2[Running OneCX Local Environment v2]
- xref:local-env:versions/v1/v1.adoc#running-onecx-local-env-v1[Running OneCX Local Environment v1]
