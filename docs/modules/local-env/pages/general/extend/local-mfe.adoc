...
This step is done with the script *toggle-mfes.sh*. It creates a configuration file with routing and path rewrite instructions that are read by Traefik. See also the documentation for xref:toggle-mfes.adoc[toggle-mfes.sh].
