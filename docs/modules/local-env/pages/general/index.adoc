...
Detailed information on how to set up and install `onecx-local-env` can be found in the xref:documentation:local-env:general/setup.adoc[Setup] documentation.

After completing the setup, the quickest way to get started is to follow the steps outlined in the xref:documentation:local-env:general/getting-started.adoc[Getting Started] guide.
