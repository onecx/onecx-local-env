...
image::script_toggle-mfes.sh_list.png[]
...
Integrate the apps 'workspace' (with specific standard port *5025*) and user-profile on port *5027*.
...
image::script_toggle-mfes.sh_activate.png[]
