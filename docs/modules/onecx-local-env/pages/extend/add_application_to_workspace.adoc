...
image::extend/workspace_left_panel.png[Select the workspace to which you want to add the application]
...
image::extend/workspaces_applications.png[Find the "Applications" tab in the workspace view]

* Click on the application you want to add to the workspace, then click `>` button in the middle of the view.

.Add the application to the workspace
image::extend/workspace_add_app.png[Select the application and click ">" button to add it to the workspace]
