...
After starting the local environment, OneCX can be accessed in a web browser by navigating to http://proxy.localhost/onecx-shell/admin[http://proxy.localhost/onecx-shell/admin].
