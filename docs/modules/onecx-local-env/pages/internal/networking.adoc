...
.Environment Variables used by OneCX Services in Docker Compose
[%collapsible]
====
...
.Environment Variable Sets in Docker Compose
[%collapsible]
====
...
Environment Variables Settings - Source::
...
.Use Environment Variable Set for BFF services
[%collapsible]
====
[source,yaml]
----
