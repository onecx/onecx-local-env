...
The OneCX Local Environment contains data required for initial xref:../scripts/start.adoc[startup]. This data is xref:../scripts/import.adoc[imported] after the services have started.
