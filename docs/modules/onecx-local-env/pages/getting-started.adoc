...
Follow the instructions at xref:./setup.adoc[Setup] to configure the base on your local machine.
...
[TIP]
====
The *start-onecx.sh* script accepts optional flags to customize its behavior. A list of available flags can be found in the xref:./scripts/start.adoc[start-onecx.sh] documentation or by running
