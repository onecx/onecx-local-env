...
* An active AI service subscription and a valid *API Key*. This key is required to access AI functionalities within OneCX. +
  You can obtain an API Key from your AI service provider.
...
. Import AI data using the following script. You will be prompted to enter your *API Key*:
+
[source,bash]
----
