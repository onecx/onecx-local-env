...
[quote]
____
This document only contains information specific to v2 of the OneCX Local Environment. Please make sure to also read the xref:../run-onecx.adoc[Getting started guide] for general information and instructions that apply to all versions.
____
