...
If you are currently using xref:./v1.adoc[OneCX Local Environment v1] and want to migrate to v2, please refer to the xref:./migrate.adoc[Migrate to v2] guide for detailed migration instructions.
