...
Detailed information on how to set up and install `onecx-local-env` can be found in the xref:general:setup/installation.adoc[Setup & Installation] documentation.

After completing the setup, the quickest way to get started is to follow the steps outlined in the xref:general:getting-started.adoc[Getting Started - Run OneCX locally] guide.
